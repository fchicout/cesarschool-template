...
O capítulo de Trabalhos Relacionados posiciona o estudo perante o estado da arte existente. Seu propósito não é meramente listar resumos de artigos anteriores, mas realizar uma \textbf{síntese crítica e comparativa} dos trabalhos publicados na literatura.
...
Recomenda-se finalizar este capítulo apresentando um \textbf{Quadro Comparativo} que contraste os trabalhos da literatura com a proposta deste projeto, evidenciando os diferenciais e a originalidade da contribuição.
